...
#ifndef ZAPFR_ENGINE_AGENTFEEDGETPOSTS_H
#define ZAPFR_ENGINE_AGENTFEEDGETPOSTS_H
...
namespace ZapFR
{
    namespace Engine
    {
        ...
        class AgentFeedGetPosts : public AgentRunnable
        {
          public:
            explicit AgentFeedGetPosts(
                uint64_t sourceID, uint64_t feedID, uint64_t perPage, uint64_t page, bool showOnlyUnread, const std::string& searchFilter, uint64_t categoryFilterID,
                FlagColor flagColor,
          ...
          private:
            ...
            FlagColor mFlagColorFilter{FlagColor::Gray};
...
#endif // ZAPFR_ENGINE_AGENTFEEDGETPOSTS_H