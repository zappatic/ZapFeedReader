...
#ifndef ZAPFR_ENGINE_AGENTSOURCEGETUSEDFLAGCOLORS_H
#define ZAPFR_ENGINE_AGENTSOURCEGETUSEDFLAGCOLORS_H
...
namespace ZapFR
{
    namespace Engine
    {
        ...
        class AgentSourceGetUsedFlagColors : public AgentRunnable
        {
          public:
...
#endif // ZAPFR_ENGINE_AGENTSOURCEGETUSEDFLAGCOLORS_H