...
#ifndef ZAPFR_ENGINE_AGENTFOLDERSORT_H
#define ZAPFR_ENGINE_AGENTFOLDERSORT_H
    ...
    namespace Engine
    {
        ...
        class AgentFolderSort : public AgentRunnable
        {
          public:
            ...
            Type type() const noexcept override { return Type::FolderSort; }
...
#endif // ZAPFR_ENGINE_AGENTFOLDERSORT_H