...
#ifndef ZAPFR_ENGINE_AGENTFOLDERREFRESH_H
#define ZAPFR_ENGINE_AGENTFOLDERREFRESH_H
...
namespace ZapFR
{
    namespace Engine
    {
        class AgentFolderRefresh : public AgentRunnable
        {
          public:
            explicit AgentFolderRefresh(uint64_t sourceID, uint64_t folderID,
...
#endif // ZAPFR_ENGINE_AGENTFOLDERREFRESH_H