...
#ifndef ZAPFR_ENGINE_AGENTSCRIPTREMOVE_H
#define ZAPFR_ENGINE_AGENTSCRIPTREMOVE_H
...
namespace ZapFR
{
    namespace Engine
    {
        class AgentScriptRemove : public AgentRunnable
        {
          public:
...
#endif // ZAPFR_ENGINE_AGENTSCRIPTREMOVE_H