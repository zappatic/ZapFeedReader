...
#ifndef ZAPFR_ENGINE_AGENTPOSTSMARKFLAGGED_H
#define ZAPFR_ENGINE_AGENTPOSTSMARKFLAGGED_H
...
namespace ZapFR
{
    namespace Engine
    {
        class AgentPostsMarkFlagged : public AgentRunnable
        {
          public:
            explicit AgentPostsMarkFlagged(uint64_t sourceID, const std::vector<std::tuple<uint64_t, uint64_t>>& feedAndPostIDs,
...
#endif // ZAPFR_ENGINE_AGENTPOSTSMARKFLAGGED_H