    ...
    namespace Engine
    {
        class SourceLocal : public Source
        {
          public:
            ...
            void setPostsFlagStatus(bool markFlagged, const std::unordered_set<FlagColor>& flagColors, const std::vector<std::tuple<uint64_t, uint64_t>>& feedsAndPostIDs) override;
