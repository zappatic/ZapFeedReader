...
std::vector<uint64_t> ZapFR::Engine::ScriptFolderRemote::markAsRead(uint64_t maxPostID)
{
...
std::vector<std::unique_ptr<ZapFR::Engine::Category>> ZapFR::Engine::ScriptFolderRemote::getCategories()
{
    ...
    if (remoteSource->remoteURLIsValid())
    {
        ...
        std::map<std::string, std::string> params;
        params[HTTPParam::Category::ParentType] = HTTPParam::Category::ParentTypeScriptFolder;
