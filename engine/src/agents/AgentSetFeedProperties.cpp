...
ZapFR::Engine::AgentSetFeedProperties::AgentSetFeedProperties(uint64_t sourceID, uint64_t feedID, const std::string& feedURL, std::optional<uint64_t> refreshIntervalInSeconds,
...
void ZapFR::Engine::AgentSetFeedProperties::run()
{
