...
ZapFR::Engine::AgentMarkPostsFlagged::AgentMarkPostsFlagged(uint64_t sourceID, const std::vector<std::tuple<uint64_t, uint64_t>>& feedAndPostIDs,
...
void ZapFR::Engine::AgentMarkPostsFlagged::run()
{
