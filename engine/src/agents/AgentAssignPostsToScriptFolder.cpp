...
ZapFR::Engine::AgentAssignPostsToScriptFolder::AgentAssignPostsToScriptFolder(uint64_t sourceID, uint64_t scriptFolderID,
...
void ZapFR::Engine::AgentAssignPostsToScriptFolder::run()
{
